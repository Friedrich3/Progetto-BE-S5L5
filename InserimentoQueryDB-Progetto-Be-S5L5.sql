...
INSERT INTO Anagrafica VALUES (NEWID(), 'Neri', 'Francesca', 'Piazza della Libertà 8', 'Napoli', '80100', 'NRIFNC85F50F839C');
...
INSERT INTO Verbale VALUES 
    (NEWID(), '2025-02-20', 'Via Roma 10', 'Agente Rizzo', '2025-03-20', 100.00, 2, 
     ...
     (SELECT idviolazione FROM Violazione WHERE Descrizione = 'Eccesso di velocità'));
...
INSERT INTO Verbale VALUES 
    (NEWID(), '2025-02-23', 'Piazza della Libertà 8', 'Agente Neri', '2025-03-23', 150.00, 4, 
